        ...
        <section id="home" className="relative min-h-screen flex items-center justify-center pt-20">
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center foreground-element">
                <div className="mb-6 inline-block">
                    <a
                        href="#contact"
                        className="inline-block px-3 py-1 rounded-full text-xs font-semibold tracking-wide text-theme-primary bg-theme-primary/10 border border-theme-primary/20 animate-fade-in-up hover:bg-theme-primary/20 hover:-translate-y-0.5 transition-all cursor-pointer"
