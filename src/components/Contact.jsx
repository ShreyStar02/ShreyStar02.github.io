        ...
        <div className="glass-card text-left p-8 md:p-10 border-theme-glass-border">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isSending}
              className={`w-full py-3 px-6 bg-theme-primary text-black font-bold rounded-lg hover:opacity-90 transition-all transform hover:-translate-y-1 shadow-lg shadow-theme-primary/20 flex justify-center items-center gap-2 ${
            ...
            <p
              className={`text-center text-sm mt-4 h-6 ${
                state === 'sent' ? 'text-green-400' : state === 'failed' ? 'text-red-400' : 'text-gray-400'
              }`}
            >
              {message}
            </p>
